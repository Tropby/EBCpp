...
EBHTTPRequest::EBHTTPRequest(std::shared_ptr<EBServerSocket> &socket) :
...
void EBHTTPRequest::sendReply(std::string data)
{
...
void EBHTTPRequest::sendReply(std::vector<uint8_t> data)
{
...
const EBHTTPHeader& EBHTTPRequest::getRequestHeader() const
{
	return requestHeader;
}


void EBHTTPRequest::start()
{
...
void EBHTTPRequest::readReady(std::shared_ptr<EBServerSocket> client)
{
	// read all data read
